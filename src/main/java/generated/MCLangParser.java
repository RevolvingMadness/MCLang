...
public class MCLangParser extends Parser {
	...
	public static final int
		...
		T__45=46, BOOLEAN=47, NULL=48, NUMBER=49, FLOAT=50, INT=51, STRING=52, 
		IDENTIFIER=53, WS=54;
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9010944466223104L) != 0)) {
				{
				{
				setState(28);
				statement();
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 14517951537348612L) != 0)) {
				{
				{
				setState(206);
				argument();
