...
public class MCLangParser extends Parser {
	...
	public static final int
		...
		T__52=53, T__53=54, T__54=55, NULL=56, BOOLEAN=57, FLOAT=58, INT=59, STRING=60, 
		IDENTIFIER=61, WS=62;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, "NULL", "BOOLEAN", "FLOAT", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2307574190271627268L) != 0)) {
				{
				{
				setState(40);
				statement(0);
	...
	public final ClassInitContext classInit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4562216791304044808L) != 0)) {
				{
				{
				setState(305);
				exprArgument();
